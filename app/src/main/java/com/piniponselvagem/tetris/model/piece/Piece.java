...
public class Piece {
    ...
    public void show() {  // Show the blocks of the piece in board
		//System.out.println("L:"+line+" C:"+column+" TYPE:"+type+" DIR:"+direction);
 		listener.whenPieceShow(this, BLOCKS[type][direction]);
    ...
    public void hide() {  // Show the grid in the position of the blocks
        listener.whenPieceHide(this, BLOCKS[type][direction]);
    	//draw(Board.BASE_LINE+line, Board.BASE_COL+column,
    ...
    public static final int[] COLORS = {  // Colors of Tetriminos
        Color.rgb(238,  0,  0) /*I*/,	Color.rgb(  0,151,214) /*J*/,	Color.rgb(242,183,  0) /*L*/,
        Color.rgb(250,250,  0) /*O*/,	Color.rgb(252, 81,139) /*S*/,	Color.rgb( 74,235,235) /*T*/,
        Color.rgb(144,205, 76) /*Z*/
    };

    public static final int GRID_LINES=4;
	public static final int GRID_COLS=4;
    public static final int MASK_INIT=0x8000;
